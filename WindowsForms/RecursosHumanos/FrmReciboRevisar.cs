    ...
    public partial class FrmReciboRevisar : Form
    {
        ...
        private void FormatoListadoRecibos()
        {
            try
            {
                ...
                this.dgvRecibos.Columns["TrabajadorCodigo"].Visible = true;
                this.dgvRecibos.Columns["TrabajadorCodigo"].HeaderText = "Codigo";
                this.dgvRecibos.Columns["TrabajadorCodigo"].Width = 80;
                this.dgvRecibos.Columns["TrabajadorCodigo"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

                this.dgvRecibos.Columns["TrabajadorNombreCompleto"].Visible = true;
                this.dgvRecibos.Columns["TrabajadorNombreCompleto"].HeaderText = "Apellidos y Nombres";
                this.dgvRecibos.Columns["TrabajadorNombreCompleto"].Width = 200;
                this.dgvRecibos.Columns["TrabajadorNombreCompleto"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

                this.dgvRecibos.Columns["TrabajadorTipo"].Visible = true;
                this.dgvRecibos.Columns["TrabajadorTipo"].HeaderText = "Tipo";
                this.dgvRecibos.Columns["TrabajadorTipo"].Width = 80;
                this.dgvRecibos.Columns["TrabajadorTipo"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

                this.dgvRecibos.Columns["TotalSueldo"].Visible = true;
                this.dgvRecibos.Columns["TotalSueldo"].HeaderText = "Sueldo";
                this.dgvRecibos.Columns["TotalSueldo"].Width = 80;
                this.dgvRecibos.Columns["TotalSueldo"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                this.dgvRecibos.Columns["TotalSueldo"].DefaultCellStyle.Format = "N2";

                this.dgvRecibos.Columns["TotalBonos"].Visible = true;
                this.dgvRecibos.Columns["TotalBonos"].HeaderText = "Bono";
                this.dgvRecibos.Columns["TotalBonos"].Width = 80;
                ...
                this.dgvRecibos.Columns["TotalDescuentos"].Width = 80;
                ...
                Util.AutoWidthColumn(ref this.dgvRecibos, "TrabajadorNombreCompleto");
        ...
        private void FrmReciboRevisar_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FrmReciboRevisar_ResizeEnd(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnVerDetalle_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.dgvRecibos.CurrentRow != null)
                {
                    ...
                    frmReciboDetalle.Cargar(uiReciboResumen.Anho, uiReciboResumen.Mes, uiReciboResumen.TrabajadorCodigo);
                }
            }
            catch (Exception ex)
            {
        ...
        private void dgvRecibos_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                frmReciboDetalle.Cargar(uiReciboResumen.Anho, 
                    uiReciboResumen.Mes, 
                    uiReciboResumen.TrabajadorCodigo);
            }
            catch (Exception ex)
            {
                Util.ErrorMessage(ex.Message);
