...
namespace ErpCasino.WindowsForms.RecursosHumanos
{
    public partial class FrmImpresion : Form
    {
        ...
        public void ImpresionRecibo(int anho, int mes, string codigoTrabajador)
        {

            try
            {
                string impresion = @"\RecursosHumanos\Impresos\ImpresionRecibo.rpt";
                ...
                crParameter3 = crParameterFieldDefinitions["@CodigoTrabajador"];
                ...
                crDiscrete3Value.Value = codigoTrabajador;
