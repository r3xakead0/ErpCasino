...
namespace ErpCasino.BusinessLibrary.BE.UI
{
    ...
    /// <summary>
    /// Calculo Resumido de Asistencia en Minutos
    /// </summary>
    public class AsistenciaResumenCalculo : ICloneable
    {
        ...
        public int AsistenciaNormalTotal
        {
            get
            {
                int normal = AsistenciaNormalDiurna + AsistenciaNormalNocturna;
                int extra1 = AsistenciaNormalDiurnaExtra1 + AsistenciaNormalNocturnaExtra1;
                int extra2 = AsistenciaNormalDiurnaExtra2 + AsistenciaNormalNocturnaExtra2;
                return normal + extra1 + extra2;
            }
        }
        ...
        public int TardanzaNormalTotal
        {
            get
            {
                return TardanzaNormalDiurna + TardanzaNormalNocturna;
            }
        }
        public int TardanzaNormalDiurna { get; set; }
        public int TardanzaNormalNocturna { get; set; }

        public int AsistenciaFeriadoTotal
        {
            get
            {
                int normal = AsistenciaFeriadoDiurna + AsistenciaFeriadoNocturna;
                int extra1 = AsistenciaFeriadoDiurnaExtra1 + AsistenciaFeriadoNocturnaExtra1;
                int extra2 = AsistenciaFeriadoDiurnaExtra2 + AsistenciaFeriadoNocturnaExtra2;
                return normal + extra1 + extra2;
            }
        }
        ...
        public int TardanzaFeriadoTotal
        {
            get
            {
                return TardanzaFeriadoDiurna + TardanzaFeriadoNocturna;
            }
        }
        public int TardanzaFeriadoDiurna { get; set; }
        public int TardanzaFeriadoNocturna { get; set; }

        public int InasistenciaTotal
        {
            get
            {
                return InasistenciaNormal + InasistenciaFeriado;
            }
        }
